...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/modules/_scripts/_webfont-loaded.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/js/modules/_scripts/_webfont-loaded.js":
/*!****************************************************!*\
  !*** ./src/js/modules/_scripts/_webfont-loaded.js ***!
  \****************************************************/
/*! no exports provided */
...
var html = document.documentElement; // Если первое посещение выполняем загрузку шрифтов через fontfaceobserver, при повторно добавляем класс к html
...
if (sessionStorage.fontsLoaded) {
  ...
  script.async = true; // Загрузка подключенных шрифтов (необходимо внести названия шрифтов в переменные)
  ...
  script.onload = function () {
    ...
    Promise.all([myFont1.load(), Myfont2.load()]).then(function () {
      html.classList.add("webfont-loaded");
...
/******/ });
//# sourceMappingURL=webfont-loaded.js.map